...
ADD (EXECUTE ON OBJECT::dbo.ImportarPacientes BY PUBLIC),
ADD (EXECUTE ON OBJECT::dbo.ImportarMedicos BY PUBLIC),
ADD (EXECUTE ON OBJECT::dbo.ImportarMedicamentos BY PUBLIC)
WITH (STATE = ON);
GO
